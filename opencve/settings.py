...
class Config(object):
    ...
    ENABLE_USER_WEBHOOK = config.getboolean("core", "enable_user_webhook", fallback=False)
    ...
    def init_app(app):
        ...
        admin.add_link(MenuLink(name="Tests", url="/admin/test"))
